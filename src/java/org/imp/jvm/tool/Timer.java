...
public class Timer {
    ...
    public static void log(String message) {
        if (LOG) {
            ...
            Util.println(colorize(Constants.TIME_SYMBOL + formattedRuntime + message, TEXT_COLOR(104)));
    ...
    public static float logTotalTime() {
        if (LOG) {
            ...
            String formattedRuntime = String.format("%.2fms", runtime);
            formattedRuntime = StringUtils.rightPad(formattedRuntime, 10);
            Util.println(colorize(Constants.TIME_SYMBOL + formattedRuntime + "done", TEXT_COLOR(212)));
            return runtime;
        }
        return 0;
    }
